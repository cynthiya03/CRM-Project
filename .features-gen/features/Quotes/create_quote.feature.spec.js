// Generated from: features\Quotes\create_quote.feature
...
test.describe('Testing Create Quote page in SuiteCRM', () => {
  ...
  test('Not allow User to save when mandatory fields are not entered', async ({ Given, When, Then }) => { 
    await Given('User is in the Create Quotes page'); 
    await When('User doesnt enter any of the mandatory fields and clicks on the Save button'); 
    await Then('User should be displayed a warning message saying "Missing required field: Title"'); 
  });
...
test.use({
  ...
  $uri: [({}, use) => use('features\\Quotes\\create_quote.feature'), { scope: 'test', box: true }],
...
const bddFileData = [ // bdd-data-start
  ...
  {"pwTestLine":24,"pickleLine":20,"tags":[],"steps":[{"pwStepLine":25,"gherkinStepLine":21,"keywordType":"Context","textWithKeyword":"Given User is in the Create Quotes page","stepMatchArguments":[]},{"pwStepLine":26,"gherkinStepLine":22,"keywordType":"Action","textWithKeyword":"When User doesnt enter any of the mandatory fields and clicks on the Save button","stepMatchArguments":[]},{"pwStepLine":27,"gherkinStepLine":23,"keywordType":"Outcome","textWithKeyword":"Then User should be displayed a warning message saying \"Missing required field: Title\"","stepMatchArguments":[{"group":{"start":50,"value":"\"Missing required field: Title\"","children":[{"start":51,"value":"Missing required field: Title","children":[{}]},{"children":[{}]}]},"parameterTypeName":"string"}]}]},
  {"pwTestLine":30,"pickleLine":25,"tags":[],"steps":[{"pwStepLine":31,"gherkinStepLine":26,"keywordType":"Context","textWithKeyword":"Given User is in the Create Quotes page","stepMatchArguments":[]},{"pwStepLine":32,"gherkinStepLine":27,"keywordType":"Action","textWithKeyword":"When user enters all the mandatory and non mandatory fields and click on Save button","stepMatchArguments":[]},{"pwStepLine":33,"gherkinStepLine":28,"keywordType":"Outcome","textWithKeyword":"Then The Quote should be saved and the user has to be directed to the quotes page","stepMatchArguments":[]}]},
  {"pwTestLine":36,"pickleLine":30,"tags":[],"steps":[{"pwStepLine":37,"gherkinStepLine":31,"keywordType":"Context","textWithKeyword":"Given User is in the Create Quotes page","stepMatchArguments":[]},{"pwStepLine":38,"gherkinStepLine":32,"keywordType":"Action","textWithKeyword":"When user enters all the mandatory and non mandatory fields and click on Cancel button","stepMatchArguments":[]},{"pwStepLine":39,"gherkinStepLine":33,"keywordType":"Outcome","textWithKeyword":"Then The quote should not be saved and user is directed to the Quotes page","stepMatchArguments":[]}]},
]; // bdd-data-end